...
function generateBio(pubs: number, tools: number): string {
  return `From excavating Paleolithic hominin sites in Kenya and Serbia to building AI models that map the human genome-phenome landscape, my path has been guided by the same set of simple principles: <em>search broadly, study deeply, and do the things that can make the biggest impact.</em>

<br><br>I started at <strong>Brown University</strong> studying cognitive neuroscience and the neural basis of decision-making, then followed that curiosity about what makes us who we are deeper into our evolutionary past through an MPhil at <strong>The George Washington University</strong>, where I investigated hippocampal evolution across primates ${paperLink('https://doi.org/10.1002/cne.24822', 'Evolutionary shifts dramatically reorganized the human hippocampal complex')} and joined paleoanthropological field schools spanning three continents.

<br><br>That drive to connect discovery with real-world impact led me to <strong>Mount Sinai</strong> in New York, where I pivoted into computational genomics and built multi-omic pipelines to identify the causal cell types and variants driving Alzheimer's ${paperLink('https://doi.org/10.1002/alz.13479', 'AI for neurodegenerative experimental models')} ${paperLink('https://doi.org/10.1038/s41588-021-00976-y', 'Genetic analysis of the human microglial transcriptome')} and Parkinson's disease ${paperLink('https://doi.org/10.1016/j.nbd.2021.105580', "Multi-omic insights into Parkinson's Disease")} ${paperLink('https://doi.org/10.1093/hmg/ddab294', "Fine-Mapping of Parkinson's Disease Susceptibility Loci")}.

<br><br>During my PhD at <strong>Imperial College London</strong> and <strong>The Alan Turing Institute</strong>, I broadened this work to systematically map cell-type-specific mechanisms across all rare diseases ${paperLink('https://doi.org/10.1101/2023.02.13.23285820', 'Cell type-specific contextualisation of the human phenome')} and constructed a unified genomic atlas of the entire human phenome ${paperLink('http://dx.doi.org/10.13140/RG.2.2.12144.26880', 'Navigating the Phenomic Landscape')}.

<br><br>Now at <strong>Cold Spring Harbor Laboratory</strong>, I am developing genomic foundation models to map complex genome-phenome relationships and enable personalized disease risk prediction. Throughout this journey, I have authored ${pubs} publications and created ${tools} open-source tools &mdash; because the best science is science that anyone can build upon.`;
}
